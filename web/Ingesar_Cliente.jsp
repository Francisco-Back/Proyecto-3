                    ...
                    <form action="ControladorPrincipal?menu=Ingesar_Cliente" method="POST">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                               <a class="btn btn-primary" href="ControladorPrincipal?menu=Ingesar_Cliente&accion=Busqueda&op=Empresa">Empresa</a>
                                    <a class="btn btn-warning" href="ControladorPrincipal?menu=Ingesar_Cliente&accion=Busqueda&op=Individual">Individual</a>
